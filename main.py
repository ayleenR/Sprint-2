...
print("First, let's start by finding the credits you are taking this semester")
...
elif (you_decide == "202"):  #Goes back to the start and chooses calculator
